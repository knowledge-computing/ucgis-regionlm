...
if __name__ == "__main__":
    ...
    parser.add_argument('--json_file_path', type=str, required=True, default = 'data/nyc_osm_pois/pois/pois_pseudo_sentence_v2_nn100_sdm100.json')
    parser.add_argument('--model_save_dir', type=str, required=True, default = 'model_weights/')
    parser.add_argument('--csv_file_path', type=str, required=False, default = 'data/nyc_osm_pois/pois/pois_pseudo_sentence_v2_nn100_sdm100_spabert_embedding.csv')

    parser.add_argument('--mode', type=str, required=True, choices=['train', 'predict'], default = 'predict')
    ...
    if args.mode == 'train':
        spabert_trainer.train_model(json_file_path=args.json_file_path,
            model_save_dir=args.model_save_dir,
            epochs=1)

    elif args.mode == 'predict':
        assert args.csv_file_path is not None 
        spabert_trainer.predict(json_file_path=args.json_file_path,
                model_save_dir=args.model_save_dir,
